...
(function (global) {
  ...
  const JOB_POOL_EXTRA = [
    ...
    // ===== 공공서비스계열 · 항공보안과 =====
    { id: 911, label_ko: '항공보안요원', ncs: { major: 'EX', major_name: '공공서비스계열(임시분류)', middle: 'EX-AV', middle_name: '공공행정·치안(항공보안)' },
      pass_profile: { planning: 74, attention: 90, simultaneous: 76, successive: 78 }, interest_code: 'OSA', interest_top1: '안전·통제형', entry_level: 'direct', attr_source: 'estimated', attr_confidence: 0.5 },
    { id: 912, label_ko: '공항운영관리자', ncs: { major: 'EX', major_name: '공공서비스계열(임시분류)', middle: 'EX-AV', middle_name: '공공행정·치안(항공보안)' },
      pass_profile: { planning: 82, attention: 80, simultaneous: 82, successive: 78 }, interest_code: 'OAB', interest_top1: '관리·정밀형', entry_level: 'bridge', attr_source: 'estimated', attr_confidence: 0.5 },
    { id: 913, label_ko: '항공기 내 보안요원', ncs: { major: 'EX', major_name: '공공서비스계열(임시분류)', middle: 'EX-AV', middle_name: '공공행정·치안(항공보안)' },
      pass_profile: { planning: 72, attention: 88, simultaneous: 78, successive: 76 }, interest_code: 'OSA', interest_top1: '안전·통제형', entry_level: 'direct', attr_source: 'estimated', attr_confidence: 0.5 },
    { id: 914, label_ko: '출입국관리 지원직', ncs: { major: 'EX', major_name: '공공서비스계열(임시분류)', middle: 'EX-AV', middle_name: '공공행정·치안(항공보안)' },
      pass_profile: { planning: 78, attention: 86, simultaneous: 74, successive: 82 }, interest_code: 'OSA', interest_top1: '안전·통제형', entry_level: 'bridge', attr_source: 'estimated', attr_confidence: 0.5 },
